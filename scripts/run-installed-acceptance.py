...
EXPECTED = {
    ...
    "extensions/pi": "f9391402bc0ccc55c663cb4eda0a5b164d9c0a27",
...
def main() -> int:
    ...
    try:
        ...
        tool_path = ":".join(("/home/node/.asdf/installs/uv/0.10.4/bin", "/home/node/.asdf/installs/nodejs/24.16.0/bin", "/home/node/.asdf/installs/python/3.12.8/bin", environment.get("PATH", "")))
        environment.update({"HOME": str(home), "PATH": tool_path, "BASH_ENV": "/dev/null", "UV_OFFLINE": "1", "NPM_CONFIG_OFFLINE": "true", "NPM_CONFIG_CACHE": "/home/node/.npm", "UV_CACHE_DIR": "/home/node/.cache/uv", "NPM_CONFIG_USERCONFIG": str(temp / ".npmrc")})
