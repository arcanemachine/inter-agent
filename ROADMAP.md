...
Next activation step: obtain explicit user authorization for the leader to perform item 10's local, non-destructive migration-readiness analysis. Do not create repositories or refs, use credentials, publish, change remotes, rewrite history, move files, or begin extraction before the applicable user gate.
